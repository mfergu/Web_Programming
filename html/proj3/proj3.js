...
var numv_key = "b1d5f828832403389f1e161a42f63498";
var numv_get_string;
var numv_return;
...
function submitNumverify(){
    numv_return = axios.get(numv_get_string)
        .then(function(response) {
            numv_return = response.data;

            //update status
            if(numv_return.valid == true){
                document.querySelector("h2").innerText = "result is a valid " + numv_return.line_type
                + " number" ;
